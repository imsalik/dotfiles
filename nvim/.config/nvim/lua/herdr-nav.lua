-- vim-herdr-navigation — Neovim side (vendored from
-- paulbkim-dev/vim-herdr-navigation editor/nvim.lua).
--
-- Seamless <C-h/j/k/l> between Neovim splits and herdr panes: move between
-- splits, and at an edge hand off to herdr so focus crosses into the
-- neighbouring pane. Falls back to tmux (if any) or plain wincmd outside herdr.
